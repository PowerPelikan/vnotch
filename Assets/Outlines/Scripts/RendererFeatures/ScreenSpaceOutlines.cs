...
public class ScreenSpaceOutlines : ScriptableRendererFeature {
    ...
    private class ScreenSpaceOutlineSettings {
        ...
        [Header("General Outline Settings"), ColorUsage(true, true)]
        public Color outlineColor = Color.black;
        [Range(0.0f, 20.0f)]
        public float outlineScale = 1.0f;
        [Range(0.0f, 20.0f)]
        public float outlinePulseMult = 1.0f;
        [Range(0.0f, 20.0f)]
        public float outlinePulseSpeed = 2.0f;
    ...
    private class ScreenSpaceOutlinePass : ScriptableRenderPass {
        ...
        public ScreenSpaceOutlinePass(RenderPassEvent renderPassEvent, ScreenSpaceOutlineSettings settings) {
            ...
            screenSpaceOutlineMaterial.SetFloat("_OutlinePulseMult", settings.outlinePulseMult);
            screenSpaceOutlineMaterial.SetFloat("_OutlinePulseSpeed", settings.outlinePulseSpeed);
